                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-10 text-right menu-1">
                                <ul>
                                    ...
                                    <li class="active"><a href="${pageContext.request.contextPath}/about">About us</a></li>
            ...
            <div id="fh5co-trainer">
                <div class="container" style="background-image:url(resources/images/img_bg_2.jpg);">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-3 animate-box">
                            <div class="developer">
                                ...
                                <img class="img-responsive myclass"  src="resources/images/About/Jaydutt.jpeg" alt="developer">
                        ...
                        <div class="col-md-3 col-sm-3 animate-box">
                            <div class="developer">
                                ...
                                <img class="img-responsive myclass" src="resources/images/About/Meet.jpeg"alt="developer">
                                <div class="title">
                        ...
                        <div class="col-md-3 col-sm-3 animate-box">
                            <div class="developer">
                                <a href="#"><img class="img-responsive myclass" src="resources/images/About/Aayush.jpg"  alt="developer"></a>
                                <div class="title">
                                    <h3><a href="#">Aayush Dalal</a></h3>
                                    <span><a href="#">Front End Developer</a></span>
                                </div>
                                <ul class="fh5co-social-icons">
                                    <li><a href="//www.google.com"><i class="icon-twitter"></i></a></li>
                                    <li><a href="#"><i class="icon-facebook"></i></a></li>
                                    <li><a href="#"><i class="icon-linkedin"></i></a></li>
                                    <li><a href="#"><i class="icon-instagram"></i></a></li>
                                </ul>
                        ...
                        <div class="col-md-3 col-sm-3 animate-box">
                            <div class="developer">
                                <a href="#"><img class="img-responsive myclass" src="resources/images/About/Dhiraj.jpeg" alt="developer"></a>
                                <div class="title">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-3 animate-box">
                            <div class="developer">
                                <a href="#"><img class="img-responsive myclass" src="resources/images/About/prashant1.jpeg" alt="developer"></a>
                                <div class="title">
                        ...
                        <div class="col-md-3 col-sm-3 animate-box">
                            <div class="developer">
                                <a href="#"><img class="img-responsive myclass" src="resources/images/About/Maulik.jpeg" alt="developer"></a>
                                <div class="title">
                        ...
                        <div class="col-md-3 col-sm-3 animate-box">
                            <div class="developer">
                                <a href="#"><img class="img-responsive myclass" src="resources/images/About/ayush.jpeg" alt="developer"></a>
                                <div class="title">
                        ...
                        <div class="col-md-3 col-sm-3 animate-box">
                            <div class="developer">
                                <a href="#"><img class="img-responsive myclass"  src="resources/images/About/Avinash.jpeg" alt="developer"></a>
                                <div class="title">
