        ...
        <div id="page">
            ...
            <header id="fh5co-header" class="fh5co-cover" role="banner" data-stellar-background-ratio="0.5">
                <div class="table-responsive">
                    <table id="table" class="table table-hover  table-dark" style="color: darkorange; margin-top: 20px;" style="background-color: black;">
                        <thead style="color: darkorange; font-size: 18px;">
                            <tr>
                                <th scope="col">Player's Name</th>
                                <th scope="col">Player's Role</th>
                                <th scope="col">Player's Country</th>
                            </tr>
                        </thead>
                        <c:forEach var="squadList" items="${squadList}" >
                            <c:forEach var="playerList" items="${playerList}" >
                                <tbody style="font-size: 18px"  >
                                    <tr onclick="getPlayerDetail(${squadList.player_id})">
                                        <td>
