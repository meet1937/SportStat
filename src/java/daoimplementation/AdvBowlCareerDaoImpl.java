 ...
 * @author MEET
 */
public class AdvBowlCareerDaoImpl implements AdvBowlCareerDao {

    @Override
    public List<Object[]> getAdvBowlStats(int player_id,int tournament_id,String year1, String team_id1, String ground_id1) {
        ...
        String hql = "from AdvBowlCareer where tournament_id=:tournament_id and player_id=:player_id and (1=:decide3 or ground_id=:ground_id) and (1=:decide2 or team_id=:team_id) and (1=:decide1 or year=:year)";
        ...
        List<Object[]> advBowlCareerList = (List<Object[]>) query.list();
        session.close();
        return advBowlCareerList;
    }
}
